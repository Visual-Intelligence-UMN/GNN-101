      ...
      >
        <div style={{ padding: 20 }}>
          ...
          <p>
            ...
            the{" "}
            <a href="https://huggingface.co/datasets/graphs-datasets/MUTAG">
              MUTAG
            </a>{" "}
          ...
          <p>
            An efficient way to represent a graph is to use an adjacency matrix.
            ...
            >
              Click to show {props.isGraphView ? "Adjacency Matrix" : "Graph"}
            </button>
          </p>

          <p>
            <span className={styles.tag}>Node Features </span> Embeddings can be
            stored the information of each graph node. In this graph, a one-hot
          ...
          <p>
            <span className={styles.tag}>Pooling </span>
            This is a paragraph explaining how to interact with the demo. The
            quick brown fox jumps over the lazy dog. The quick brown fox jumps
            over the lazy dog. The quick brown fox jumps over the lazy dog. The
            quick brown fox jumps over the lazy dog. The quick brown fox jumps
